 ...
 const guageData = [
    {
      ...
      mode: "gauge+number",     
       ...
       bar: { color: "green" },
       steps: [
          { range: [0, 1], color: "rgba(0, 128, 128, 0.2)" },
          { range: [1, 2], color: "rgba(0, 128, 128, 0.3)" },
          { range: [2, 3], color: "rgba(0, 128, 128, 0.4)" },
          { range: [3, 4], color: "rgba(0, 128, 128, 0.5)" },
          { range: [4, 5], color: "rgba(0, 128, 128, 0.6)" },
          { range: [5, 6], color: "rgba(0, 128, 128, 0.7)" },
          { range: [6, 7], color: "rgba(0, 128, 128, 0.8)" },
          { range: [7, 8], color: "rgba(0, 128, 128, 0.9)" },
          { range: [8, 9], color: "rgba(0, 128, 128, 1.0)" }
